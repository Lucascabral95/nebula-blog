...
import { useUserSection } from '@/presentation/hooks/useUserSection'
...
const SeccionUsuario = () => {
  ...
  const { currentSection, setCurrentSection, address, userPosts, user, favorites, modalState, openModal, closeModal, handleRemoveFavorite } = useUserSection()
  ...
  return (
    <EstructuraCuerpo>
      <EstructuraCuerpoInterior
        ...
        recomendaciones={<PerfilDeDatos dataMyPosts={userPosts} datosDelUsuario={user} id={id as any} />}
      />
    </EstructuraCuerpo>
  )
}
